...
for filenum = 8296:1:9123;%filenumbers
    ...
    ajinkya3 = a_lv_rcvd;
    ajinkya4 = v_lv_rcvd';
    ajinkya5 = WarningRangeCalculatedUsingReceivedInfo';
    ajinkya6 = est_Separation_Dist';
    ajinkya7 = ajinkya5 > ajinkya6;
    ajinkya8 = GroundTruthAlertRange > GrndTrth_Separation_Dist;
    ajinkya9 = ajinkya8';
    damn = [ajinkya1, ajinkya2, ajinkya3, ajinkya4, ajinkya7, ajinkya9];
    filename = ['file' num2str(filenum) '.csv'];
    var = damn;
    dlmwrite(fullfile('C:\Users\ajinkya145\Desktop\Spring 2017\Modeling and Analysis of Networked Cyber-Physical Systems\FCWProject\PERO\trial',filename), var);
